module github.com/algonode/algovnode

go 1.18

require (
	github.com/algorand/go-algorand v0.0.0-20220604013213-5e6c918c9d7a
...
require (
	github.com/algorand/falcon v0.0.0-20220502155100-9558ec1e8b01 // indirect
